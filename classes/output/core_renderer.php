...
namespace theme_pbs\output;

use theme_config;
use context_course;
use moodle_url;
use html_writer;
use theme_pbs\output\core_course\activity_navigation;
...
class core_renderer extends \theme_boost\output\core_renderer
{
    ...
    {
        $hasaccessibilitybar = get_user_preferences('themepbssettings_enableaccessibilitytoolbar', '');
        ...
        $fonttype = get_user_preferences('themepbssettings_fonttype', '');
        if ($fonttype) {
    ...
    {
        $callbacks = get_plugins_with_function('pbs_additional_header', 'lib.php');
