...
class settings
{
    ...
    {
        $this->theme = theme_config::load('pbs');
    }
    ...
    public function footer()
    {
        ...
        $templatecontext['hassocials'] = $hassocials;
    ...
    public function frontpage_slideshow()
    {
        ...
        $defaultimage = new \moodle_url('/theme/pbs/pix/default_slide.jpg');
    ...
    public function frontpage_marketingboxes()
    {
        if ($templatecontext['displaymarketingbox'] = $this->displaymarketingbox) {
            ...
            $defaultimage = new \moodle_url('/theme/pbs/pix/default_markegingicon.svg');
